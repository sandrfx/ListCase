 ...
 */
public class GitReposListInteractorImpl implements GitReposListInteractor {

    private GitReposRepository gitReposRepository;

    public GitReposListInteractorImpl(@NonNull GitReposRepository gitReposRepository) {
        this.gitReposRepository = gitReposRepository;
    }

    @Override
    public Single<List<GitRepoModel>> getTopAndroidRepos(int page) {
        return gitReposRepository.getTopAndroidRepos(page);
    }
}
