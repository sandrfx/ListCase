...
import com.sandrlab.listcase.repositories.GitReposRepositoryImpl;
...
public final class AppModule {
    ...
    @NonNull
    @Singleton
    GitReposRepository provideGitReposRepository(@NonNull GitHubApi gitHubApi) {
        return new GitReposRepositoryImpl(gitHubApi);
    }
}
